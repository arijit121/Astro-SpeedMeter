        ...
        <div>
            {/*  Pulsing “core” circle */}
            {
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[var(--color-primary)] rounded-full blur-[150px] opacity-10 animate-pulse"></div>
                </div>
            }
            <div className="z-10 text-center mb-4 mt-16 px-4">
                <h1 className="text-4xl md:text-6xl font-bold mb-4 drop-shadow-[0_0_15px_rgba(0,255,225,0.5)]">
                    MEASURE YOUR <span className="text-[var(--color-primary)] text-neon">SPEED</span>
                </h1>
                <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                    Experience the future of connectivity. Accurate, fast, and secure speed testing powered by edge computing.
                </p>
            </div>
